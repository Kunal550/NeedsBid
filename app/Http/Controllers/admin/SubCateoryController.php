...
class SubCateoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.panel.subcategory.index', compact('data'));
    }
    ...
    {
        return view('admin.panel.subcategory.create');
    }
    ...
    public function edit($subCateory)
    {
        ...
        return view('admin.panel.subcategory.edit', compact('data'));
    }
    ...
    public function update(Request $request, SubCategory $subCateory)
    {
        ...
        return redirect()->route('admin.subcategory.list')->with('info', 'SubCategory updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.subcategory.list')->with('error', 'SubCategory deleted successfully.');
    }
}
