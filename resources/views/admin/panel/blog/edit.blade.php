...
@section('mytitle', 'Blog | Edit | Admin')
@push('style')
<style>
    .error {
        color: red;
...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <form action="{{ route('admin.cms.blog.update') }}" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                <input type="hidden" name="blog_id" id="blog_id" value="{{ base64_encode($data->id) }}">
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="">Name<span class="req">*</span></label>
                                <input type="text" name="blog_name" id="blog_name" class="form-control" value="{{ $data->name }}" placeholder="Blog Name">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <a href="{{ URL::to('public/uploads/blog/' . $data->blog_images) }}" class="image-showbanner" target="_blank"> <img src="{{ URL::to('public/uploads/blog/' . $data->blog_images) }}" class="img" id="editimg" alt=""></a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="blog_description" id="blog_description" {{ $data->description }} class="form-control">{!! $data->description !!}</textarea>
