...
@section('mytitle', 'Constructor | Edit | Admin')
@push('style')
<style>
    .error {
        color: red;
...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <form action="{{ route('admin.constructor-type.update') }}" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                <input type="hidden" name="constructor_id" id="constructor_id" value="{{ base64_encode($data->id) }}">
