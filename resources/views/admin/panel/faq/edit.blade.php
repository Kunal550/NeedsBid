...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <form action="{{ route('admin.cms.faq.update') }}" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                <input type="hidden" name="faq_id" id="faq_id" value="{{ base64_encode($data->id) }}">
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10">
                                <label for="question">Question<span class="req">*</span></label>
                                <input type="text" name="question" id="question" class="form-control" value="{{ $data->question }}" placeholder="Question">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="answer" id="answer" value="{{ $data->answer }}" class="form-control">{!! $data->answer !!}</textarea>
