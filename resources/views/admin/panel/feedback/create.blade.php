...
@section('mytitle', 'Feedback | Create | Admin')
@push('style')
<style>
    .error {
        color: red;
...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <form action="{{ route('admin.cms.feedback.store') }}" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="client_desc" id="client_desc" class="form-control"></textarea>
