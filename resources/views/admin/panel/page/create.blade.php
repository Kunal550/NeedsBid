...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <form action="{{ route('admin.cms.pages.store') }}" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Pages Title">
                                @if ($errors->has('name'))
