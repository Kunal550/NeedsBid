...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <form action="{{ route('admin.cms.testimonial.update') }}" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                <input type="hidden" name="test_id" id="test_id" value="{{ base64_encode($data->id) }}">
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="">Name<span class="req">*</span></label>
                                <input type="text" name="testimonial_name" id="testimonial_name" value="{{ $data->name }}" class="form-control" placeholder="Testimonial Title">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="designation" id="designation" value="{{ $data->designation }}" class="form-control" placeholder="Enter Designation">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="rating" id="rating" value="{{ $data->rating }}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="testimonial_image" id="testimonial_image" class="form-control" accept="image/*">
                                <a href="{{ URL::to('public/uploads/testimonial_image/' . $data->testimonial_image) }}" class="image-showbanner" target="_blank"> <img src="{{ URL::to('public/uploads/testimonial_image/' . $data->testimonial_image) }}" class="img" id="editimg" alt=""></a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="testimonial_desc" id="testimonial_desc" class="form-control" value="{{ $data->description }}">{{ strip_tags($data->description) }}</textarea>
...
<script>
    ...
    $(function() {
        ...
        const currentRating = parseFloat($('#rating').val()) || 0;
        ...
        $("#rateYo").rateYo({
            ...
            onSet: function(rating, rateYoInstance) {
                $('#rating').val(rating); // update hidden input
            }
        });
    });
