                                    ...
                                    <div class="filters-scroll">
                                        ...
                                        @foreach ($colors as $color)
                                            <div class="form-check color-check">
                                                <label class="form-check-label"><input class="form-check-input colorInput"
                                                        name="color[]" name="checkbox" type="checkbox"
                                                        value="{{ $color->slug }}"
                                                        {{ isset($_GET['color']) && in_array($color->slug, $_GET['color']) ? 'checked' : '' }}>
                                                    &nbsp; {{ $color->color_name }}
                                                    ({{ !empty($colorCounts[$i]->counts) ? $colorCounts[$i]->counts : 0 }})
                                                </label>
                                            </div>
                                            @php
                                                $i++;
                                        ...
                                        @foreach ($brands as $brand)
                                            <div class="form-check brand-check">
                                                <label class="form-check-label">
                                                    ...
                                                    {{ $brand->brand_name }}
                                                    ({{ !empty($brandCounts[$i]->counts) ? $brandCounts[$i]->counts : 0 }})
                                                </label>
                                            </div>
                                            @php
                                                $i++;
